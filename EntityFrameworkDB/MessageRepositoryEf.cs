...
namespace Infrastructure.EntityFramework
{
    public class MessageRepositoryEf : IMessageRepository
    {
        ...
        public virtual void Add(string login, Message model)
        {
            ...
            // Los campos origen, model y model.destino no pueden ser nulos
        ...
        public virtual ICollection<Message> Get(string login) => _context.Set<Message>().Where(m=>m.From.Login==login).ToList();
